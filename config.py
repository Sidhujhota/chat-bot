...
OWNER_ID = int(getenv("OWNER_ID", "6394947574"))
MONGO_URL = getenv("MONGO_URL", None)
SUPPORT_GRP = getenv("SUPPORT_GRP", "PUNJXB")
UPDATE_CHNL = getenv("UPDATE_CHNL", "sidhuchatx")
OWNER_USERNAME = getenv("OWNER_USERNAME", "i_am_champion")
